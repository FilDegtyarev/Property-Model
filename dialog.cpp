...
void dialog_test() {
	...
	pmb.add_variable<Belong::DataVariable, int>("initial_h", 1000);
	pmb.add_variable<Belong::DataVariable, int>("initial_w", 2000);

	pmb.add_variable<Belong::ValueVariable, int>("relative_h", 100);
	pmb.add_variable<Belong::ValueVariable, int>("absolute_h", 1000);
	pmb.add_variable<Belong::ValueVariable, int>("relative_w", 100);
	pmb.add_variable<Belong::ValueVariable, int>("absolute_w", 2000);
